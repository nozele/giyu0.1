...
client.on("chat", ( channel, user, message, self)=> {
  ...
  if (message == "!nam!") {
    client.say(channel, "NaM RICE ALL DAY")
  }
  if (message == "TriHard ") {
    client.say(channel, "WideHard")
  }
  if (message == "trash bot") {
    client.say(channel, "FUCK YOU :) ")
  }
  if (message == "!kresh") {
    client.say(channel, "the racist cmonBruh ")
  }
  if (message == "cmonBruh") {
    client.say(channel, "cmonBruh WTF ")
  }
})
